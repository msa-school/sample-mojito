<template>
  <div>
    <h1 style = "margin-left:4.5%; margin-top:-10px;">Weather</h1>
    ...
    <v-row>
        <Weather :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
    </v-row>
  </div>
</template>
