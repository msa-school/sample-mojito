<template>
    ...
    <v-card style="width:300px;" outlined>
        ...
        <v-card-title v-if="value._links">
            FoodRecommendation # {{value._links.self.href.split("/")[value._links.self.href.split("/").length - 1]}}
        </v-card-title >
        <v-card-title v-else>
            FoodRecommendation
        </v-card-title >
        ...
        <v-card-text>
            ...
            <div>
                <String label="Restraunt" v-model="value.restraunt" :editMode="editMode"/>
            </div>
            <div>
                <String label="Photo" v-model="value.photo" :editMode="editMode"/>
            </div>
            <div>
    ...
    export default {
        ...
        created(){
            ...
            if(typeof this.value === 'object') {
                ...
                if(!('restraunt' in this.value)) {
                    this.value.restraunt = null;
                }
        ...
        methods: {
            ...
            async save(){
                try {
                    ...
                    if(!this.offline) {
                        if(this.isNew) {
                            temp = await axios.post(axios.fixUrl('/foodRecommendations'), this.value)
                        } else {
