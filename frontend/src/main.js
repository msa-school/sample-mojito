...
pluralCaseList.push( {plural: "attireRecommendations", pascal: "AttireRecommendation"} )

pluralCaseList.push( {plural: "activityRecommendations", pascal: "ActivityRecommendation"} )

pluralCaseList.push( {plural: "foodRecommendations", pascal: "FoodRecommendation"} )

pluralCaseList.push( {plural: "users", pascal: "User"} )

pluralCaseList.push( {plural: "personalizedRecommendations", pascal: "PersonalizedRecommendation"} )
pluralCaseList.push( {plural: "weathers", pascal: "Weather"} )
